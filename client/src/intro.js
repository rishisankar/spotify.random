...
class Intro extends Component {
    ...
    render() {
        ...
        else return <Redirect push to="/djboard" />;
    }
}
...
class TextBox extends Component {
    constructor(props) {
        ...
        this.messages = [
            "<span class=\"text_title\">welcome to spotify.random!</span><br /> press 'space' to continue or 's' to skip",
        ...
        return (
            <div id="speech_bubble">
                {this.state.textState && (
                    <Typewriter
                        options={{
                            strings: this.messages[this.state.messageNumber],
                            autoStart: true,
                            delay: 60,
                        }}
                    />
